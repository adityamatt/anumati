...
const ROOTS = ["/Users/you/project", "/tmp/scratch"];

describe("matchSafeWrite", () => {
  it("allows a file inside an allowed root", () =>
    expect(matchSafeWrite("/Users/you/project/src/index.ts", ROOTS, "")).toBe(true));
  ...
  it("allows the root directory itself", () =>
    expect(matchSafeWrite("/Users/you/project", ROOTS, "")).toBe(true));

  it("resolves a relative path against cwd", () =>
    expect(matchSafeWrite("src/index.ts", ROOTS, "/Users/you/project")).toBe(true));
  ...
  it("blocks a sibling dir that shares a prefix", () =>
    expect(matchSafeWrite("/Users/you/project-evil/x.ts", ROOTS, "")).toBe(false));

  it("blocks .. traversal that escapes the root", () =>
    expect(matchSafeWrite("/Users/you/project/../../../etc/passwd", ROOTS, "")).toBe(false));

  it("allows .. that stays inside the root", () =>
    expect(matchSafeWrite("/Users/you/project/src/../lib/x.ts", ROOTS, "")).toBe(true));

  it("blocks when no roots configured", () =>
    expect(matchSafeWrite("/Users/you/project/x.ts", [], "")).toBe(false));
