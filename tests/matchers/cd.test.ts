...
const CWD = "/Users/you/project";

describe("matchCd — allow", () => {
  it("cd into cwd itself (absolute)", () =>
    expect(matchCd("cd /Users/you/project", CWD)).toBe(true));

  it("cd into a subfolder (absolute)", () =>
    expect(matchCd("cd /Users/you/project/src/lib", CWD)).toBe(true));
...
describe("matchCd — block", () => {
  ...
  it("cd to a prefix-sibling of cwd", () =>
    expect(matchCd("cd /Users/you/project-evil", CWD)).toBe(false));
